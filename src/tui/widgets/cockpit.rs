...
impl<'a> CockpitPanel<'a> {
    ...
    fn render_summary(&self, frame: &mut Frame, area: Rect) {
        ...
        lines.push(Line::from(vec![
            ...
            Span::styled(duration_str(self.duration_secs), Style::default().fg(THEME.text)),
        ]));
...
mod tests {
    ...
    fn tab_navigation_logic() {
        ...
        assert_eq!(CockpitTabDisplay::from_index(3), CockpitTabDisplay::Timeline);
        assert_eq!(CockpitTabDisplay::from_index(4), CockpitTabDisplay::Timeline);
    }
}
